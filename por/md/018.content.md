...
* **Associated ACAI Concepts:** Rôs (ID: `person:Rosh`); Rafa (ID: `person:Rapha`); Vale de Refaim (ID: `place:RephaimValley`)
...
(Veja também: Assuero, Atalia, Ester, rei. Governante daPérsia, Sabá)
...
* **Associated ACAI Concepts:** Ramote-Gileade (ID: `place:Ramoth-gilead`); Ramah (ID: `place:Ramah.6`); Ramah (ID: `place:Ramah.8`); Ramá (ID: `place:Ramah`); Ramah (ID: `place:Ramah.2`); Ramah (ID: `place:Ramah.4`); Ramah (ID: `place:Ramah.3`); Ramah (ID: `place:Ramah.7`)
