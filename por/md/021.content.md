...
* **Associated ACAI Concepts:** Ur (ID: `place:Ur`); Harã (ID: `person:Haran`); Caldéia (ID: `place:Chaldea`)
## Urias (id: 238456)
...
* **Associated ACAI Concepts:** Urias (ID: `person:Uriah`); Urias (ID: `person:Uriah.4`); Urias (ID: `person:Uriah.5`)
## Urso (id: 237652)
...
* **Associated ACAI Concepts:** Uzias (ID: `person:Uzziah`); Ezequias (ID: `person:Hezekiah`)
