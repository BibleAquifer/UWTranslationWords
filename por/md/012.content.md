...
* **Associated ACAI Concepts:** Spear (ID: `realia:Spear`); Elanã (ID: `person:Elhanan`)
## Lázaro (id: 238091)
...
* **Associated ACAI Concepts:** libertar (ID: `keyterm:Rescue`); livrar (ID: `keyterm:Deliver`)
## Lícito (id: 191640)
...
* **Associated ACAI Concepts:** Holy Place (ID: `place:HolyPlace`); Holy Place (ID: `place:HolyPlace.2`); The Holy Place (ID: `realia:TheHolyPlace`); Lugar Santíssimo (ID: `place:MostHolyPlace`)
