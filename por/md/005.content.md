...
* **Associated ACAI Concepts:** Dã (ID: `person:Dan`); Dã (ID: `place:Dan`); Dã (ID: `group:Dan`)
...
* **Associated ACAI Concepts:** Daniel (ID: `person:Daniel.2`); Daniel (ID: `person:Daniel.3`); Quileabe (ID: `person:Chileab`)
...
* **Associated ACAI Concepts:** Judá (ID: `person:Judah.4`); Davi (ID: `person:David`)
...
* **Associated ACAI Concepts:** testemunhar solenemente (ID: `keyterm:Declare`); proclamar (ID: `keyterm:Proclaim`)
