...
* **Associated ACAI Concepts:** Dã (ID: `group:Dan`); Dã (ID: `person:Dan`); Dã (ID: `place:Dan`)
## Dalila (id: 237788)
...
* **Associated ACAI Concepts:** Dario (ID: `person:Darius.2`); Dario (ID: `person:Darius`)
## Davi (id: 237778)
...
* **Associated ACAI Concepts:** dedicate (ID: `keyterm:Dedicate.2`)
## deleite (id: 237787)
...
* **Associated ACAI Concepts:** Deserto do Sinai (ID: `place:SinaiWilderness`); Deserto de Sin (ID: `place:Sin`)
## desgraça (id: 237812)
...
* **Associated ACAI Concepts:** abomination (ID: `keyterm:DetestedThing`); mischief (ID: `keyterm:Mischief`); wickedness (ID: `keyterm:Wickedness`)
## Desolado (id: 237796)
...
* **Associated ACAI Concepts:** distinguir (ID: `keyterm:Discern`); perceive (ID: `keyterm:Perceive`)
## Discípulo (id: 237802)
