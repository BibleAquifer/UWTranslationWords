...
* **Associated ACAI Concepts:** Complete (ID: `keyterm:Complete`); irrepreensível (ID: `keyterm:Unblemished`); irrepreensível (ID: `keyterm:WithoutReproach`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Israel (ID: `place:Israel`); SENHOR (ID: `deity:Lord`)
