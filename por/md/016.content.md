...
* **Associated ACAI Concepts:** Parã (ID: `place:Paran`); Monte Paran (ID: `place:ParanMount`)
...
* **Associated ACAI Concepts:** parábola (ID: `keyterm:Parable`); saying (ID: `keyterm:Saying`)
