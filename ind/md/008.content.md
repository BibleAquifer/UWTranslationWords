...
* **Associated ACAI Concepts:** Air (ID: `place:WaterGate`); Door (ID: `realia:Door`); Mata (ID: `place:FountainGate`); gerbang (ID: `place:DungGate`); Lebak (ID: `place:ValleyGate`); gerbang (ID: `place:SheepGate`); Bait (ID: `place:BeautifulGate`); Ikan (ID: `place:FishGate`); Efraim (ID: `place:EphraimGate`); East Gate (ID: `place:EastGate`); Kuda (ID: `place:HorseGate`)
