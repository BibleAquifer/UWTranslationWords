...
* **Associated ACAI Concepts:** gerbang (ID: `place:SheepGate`); gerbang (ID: `place:DungGate`); gerbang (ID: `place:YeshanahGate`); gerbang (ID: `place:GuardGate`)
## Gesur (id: 675872)
...
* **Associated ACAI Concepts:** Getsemani (ID: `place:Gethsemane`); menjadi murid (ID: `keyterm:Disciple`); Olive Tree (ID: `flora:OliveTree`); berdoa (ID: `keyterm:Pray`)
## Gibea (id: 675874)
...
* **Associated ACAI Concepts:** Goliat (ID: `person:Goliath`); Filistin (ID: `group:Philistine`); Gat (ID: `place:Gath`)
## Gomora (id: 675886)
