...
* **Associated ACAI Concepts:** Air (ID: `place:WaterGate`); gerbang (ID: `place:SheepGate`); gerbang (ID: `place:DungGate`); Lebak (ID: `place:ValleyGate`); Mata (ID: `place:FountainGate`); Door (ID: `realia:Door`); Ikan (ID: `place:FishGate`); Bait (ID: `place:BeautifulGate`); Efraim (ID: `place:EphraimGate`); Kuda (ID: `place:HorseGate`); East Gate (ID: `place:EastGate`)
