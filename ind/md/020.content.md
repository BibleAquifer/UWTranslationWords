...
* **Associated ACAI Concepts:** Ark of the Covenant (ID: `realia:ArkOfTheCovenant`); tabut (ID: `keyterm:CovenantBox`)
...
* **Associated ACAI Concepts:** tak bernoda (ID: `keyterm:Unblemished`); lengkap (ID: `keyterm:Complete`); tak bercacat (ID: `keyterm:WithoutReproach`); lepas atau bebas dari sumpah (ID: `keyterm:Blameless`)
...
* **Associated ACAI Concepts:** Holy Place (ID: `place:HolyPlace.2`); kudus (ID: `place:HolyPlace`); khusus (ID: `keyterm:Holy`); The Holy Place (ID: `realia:TheHolyPlace`)
