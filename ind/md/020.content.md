...
* **Associated ACAI Concepts:** tak bernoda (ID: `keyterm:Unblemished`); tak bercacat (ID: `keyterm:WithoutReproach`); lengkap (ID: `keyterm:Complete`); lepas atau bebas dari sumpah (ID: `keyterm:Blameless`)
