...
* **Associated ACAI Concepts:** raja (ID: `person:Hammelech`); raja (ID: `person:Jehoiachin`); raja (ID: `place:KingsValley`)
...
* **Associated ACAI Concepts:** Rock of Rimmon (ID: `place:Rimmon.3`); Rimon (ID: `deity:Rimmon`); Rimon (ID: `person:Rimmon`)
