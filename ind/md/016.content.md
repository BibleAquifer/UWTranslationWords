...
* **Associated ACAI Concepts:** Obaja (ID: `person:Obadiah.4`); Obaja (ID: `person:Obadiah.2`); Obaja (ID: `person:Obadiah.12`); Obaja (ID: `person:Obadiah.10`); Obaja (ID: `person:Obadiah.11`); Obaja (ID: `person:Obadiah.5`); Zebaja (ID: `person:Zebadiah.8`)
## Og (id: 676080)
...
* **Associated ACAI Concepts:** Og (ID: `person:Og`); Ir (ID: `person:Ir`)
## Omri (id: 676081)
...
* **Associated ACAI Concepts:** Omri (ID: `person:Omri`); Ahazia (ID: `person:Ahaziah.2`); Yerusalem (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** bodoh (ID: `keyterm:Stupid`); bodoh (ID: `keyterm:Foolish`); orang bodoh (ID: `keyterm:Fool`)
...
* **Associated ACAI Concepts:** Kanaan (ID: `place:Canaan`); Tuhan (ID: `deity:Lord`); Cherethites (ID: `group:Cherethite`); firman tuhan (ID: `keyterm:WordOfTheLord`); Filistin (ID: `place:Philistine`)
