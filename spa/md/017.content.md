...
* **Associated ACAI Concepts:** parábola (ID: `keyterm:Parable`); dicho (ID: `keyterm:Saying`)
...
* **Associated ACAI Concepts:** Parán (ID: `place:Paran`); Parán (ID: `place:ParanMount`)
...
* **Associated ACAI Concepts:** Persas (ID: `place:Persia`)
