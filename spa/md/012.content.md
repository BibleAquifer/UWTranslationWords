...
* **Associated ACAI Concepts:** Kedesh (ID: `place:Kedesh.3`); Cedes (ID: `place:Kedesh`); Cades (ID: `place:Kadesh-barnea`)
...
* **Associated ACAI Concepts:** Coré (ID: `person:Korah.2`); Coré (ID: `person:Korah.3`); Coré (ID: `person:Korah.4`); Coré (ID: `person:Korah`)
