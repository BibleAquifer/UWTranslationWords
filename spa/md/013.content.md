...
* **Associated ACAI Concepts:** Líbano (ID: `place:Lebanon`); Hermón (ID: `place:HermonMount`); del (ID: `place:HouseOfTheForestOfLebanon`); Líbano (ID: `place:LebanonMount`)
...
* **Associated ACAI Concepts:** Holy Place (ID: `place:HolyPlace.2`); santuario (ID: `place:HolyPlace`); santísimo (ID: `place:MostHolyPlace`)
