...
* **Associated ACAI Concepts:** Water Gate (ID: `place:WaterGate`); Door (ID: `realia:Door`); Dung Gate (ID: `place:DungGate`); Sheep Gate (ID: `place:SheepGate`); Valley Gate (ID: `place:ValleyGate`); Fountain Gate (ID: `place:FountainGate`); Fish Gate (ID: `place:FishGate`); Beautiful Gate (ID: `place:BeautifulGate`); Ephraim Gate (ID: `place:EphraimGate`); Horse Gate (ID: `place:HorseGate`); East Gate (ID: `place:EastGate`)
