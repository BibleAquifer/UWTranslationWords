...
* **Associated ACAI Concepts:** Chaldeans (ID: `group:Chaldea`); Wakaldayo (ID: `place:Chaldea`)
...
* **Associated ACAI Concepts:** Jebusites (ID: `group:Jebusites`); Yerusalemu (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Be Zealous (ID: `keyterm:Zealous`)
