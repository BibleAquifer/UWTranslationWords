...
* **Associated ACAI Concepts:** Amalekites (ID: `group:Amalek`); Amaleki (ID: `place:Amalek`)
...
* **Associated ACAI Concepts:** Waarabu (ID: `place:Arabia`); Arabians (ID: `group:Arabia`); Arabia Petraea (ID: `place:Arabia.2`)
...
* **Associated ACAI Concepts:** Chaldeans (ID: `group:Chaldea`); Wakaldayo (ID: `place:Chaldea`); Babylonia (ID: `place:Babylonia`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Resentment (ID: `keyterm:Resentment`); Jealous (ID: `keyterm:Zealous.2`); Passion (ID: `keyterm:Ardour`)
