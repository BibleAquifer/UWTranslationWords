...
* **Associated ACAI Concepts:** maji (ID: `place:WaterGate`); Door (ID: `realia:Door`); chemchemi (ID: `place:FountainGate`); jaa (ID: `place:DungGate`); bondeni (ID: `place:ValleyGate`); kondoo (ID: `place:SheepGate`); Mzuri (ID: `place:BeautifulGate`); samaki (ID: `place:FishGate`); Efraimu (ID: `place:EphraimGate`); mashariki (ID: `place:EastGate`); farasi (ID: `place:HorseGate`)
