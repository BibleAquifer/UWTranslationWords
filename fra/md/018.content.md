...
* **Associated ACAI Concepts:** porte des eaux (ID: `place:WaterGate`); Door (ID: `realia:Door`); porte de la source (ID: `place:FountainGate`); porte du fumier (ID: `place:DungGate`); porte de la vallée (ID: `place:ValleyGate`); porte des brebis (ID: `place:SheepGate`); Beautiful Gate (ID: `place:BeautifulGate`); porte des poissons (ID: `place:FishGate`); porte d'Éphraïm (ID: `place:EphraimGate`); East Gate (ID: `place:EastGate`); porte des chevaux (ID: `place:HorseGate`)
