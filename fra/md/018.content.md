...
* **Associated ACAI Concepts:** parabole (ID: `keyterm:Parable`); proverbe (ID: `keyterm:Saying`)
...
* **Associated ACAI Concepts:** Paran (ID: `place:Paran`); montagne de Paran (ID: `place:ParanMount`)
...
* **Associated ACAI Concepts:** Perse (ID: `place:Persia`)
