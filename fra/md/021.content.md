...
* **Associated ACAI Concepts:** Sabéen (ID: `person:Sheba.2`); Sheba (ID: `person:Sheba.3`); Sheba (ID: `person:Sheba.4`); Sheba (ID: `person:Sheba.5`); Sheba (ID: `person:Sheba`); Beersheba (ID: `place:Beersheba`); Sheba (ID: `place:Sheba.2`); Saba (ID: `person:Seba`); Saba (ID: `place:Seba`)
...
* **Associated ACAI Concepts:** Wine (ID: `realia:Wine`); offrande (ID: `keyterm:Offering`)
...
* **Associated ACAI Concepts:** Samaria (ID: `place:Samaria.2`); Samarie (ID: `place:Samaria`)
...
* **Associated ACAI Concepts:** Saül (ID: `person:Saul.2`); Paul (ID: `person:Paul`); Shaul (ID: `person:Shaul`); Shaul (ID: `person:Shaul.2`)
...
* **Associated ACAI Concepts:** Schimeï (ID: `person:Shimei.10`); Schimeï (ID: `person:Shimei.11`); Schimeï (ID: `person:Shimei.12`); Schimeï (ID: `person:Shimei.13`); Schimeï (ID: `person:Shimei.14`); Schimeï (ID: `person:Shimei.15`); Schimeï (ID: `person:Shimei.16`); Schimeï (ID: `person:Shimei.17`); Schimeï (ID: `person:Shimei.18`); Schimeï (ID: `person:Shimei.2`); Schimea (ID: `person:Shimeah.2`); Schimeï (ID: `person:Shimei.4`); Schimeï (ID: `person:Shimei.5`); Schimeï (ID: `person:Shimei.6`); Schimeï (ID: `person:Shimei.7`); Schimeï (ID: `person:Shimei.8`); Schimeï (ID: `person:Shimei.9`); Obed-edom (ID: `person:Obed-edom`)
...
* **Associated ACAI Concepts:** Schinear (ID: `place:Shinar`); Babylonia (ID: `place:Babylonia`)
...
* **Associated ACAI Concepts:** Sichem (ID: `person:Shechem.2`); Sichem (ID: `person:Shechem.3`); Sichem (ID: `person:Shechem`); Sichem (ID: `place:Shechem`); chênes de Moré (ID: `place:Moreh`)
...
* **Associated ACAI Concepts:** Sidon (ID: `person:Sidon`); Sidon (ID: `place:Sidon`); Sidonien (ID: `group:Sidon`)
...
* **Associated ACAI Concepts:** Siméon (ID: `person:Simeon.2`); Siméon (ID: `person:Simeon.3`); Siméon (ID: `person:Simeon.4`); Siméon (ID: `person:Simeon.5`); Pierre (ID: `person:Peter`); Siméon (ID: `group:Simeon`)
...
* **Associated ACAI Concepts:** Simon (ID: `person:Simon.2`); zélote; nationaliste (ID: `group:Zealot`)
...
* Le tirage au sort par un sacrificateur était parfois utilisé par les Israélites dans des contextes spécifiques pour connaître la volonté de Dieu (par exemple, pour choisir le bouc à sacrifier à Dieu au Jour des Expiations, voir Lévitique 16\.8–10).
* Dans le Nouveau Testament, il était utilisé pour déterminer quel sacrificateur exécuterait une fonction spécifique à un moment donné dans le Temple (voir l'exemple de Zacharie dans Luc 1\.8–10\).
* Le tirage au sort était aussi utilisé dans des contextes païens (par exemple, par les marins quand ils sont en danger à cause de la tempête, voir Jonas 1\.7). Les soldats qui ont crucifié Jésus ont tiré au sort pour savoir qui garderait sa tunique (voir Luc 23\.34).
