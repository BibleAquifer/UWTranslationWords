...
* **Associated ACAI Concepts:** Demons (ID: `deity:Demons`); être possédé par un démon (ID: `keyterm:DemonPossessed`)
...
* **Associated ACAI Concepts:** Shur (ID: `place:Shur`); désert de Sinaï (ID: `place:SinaiWilderness`); Paran (ID: `place:Paran`); désert de Sin (ID: `place:Sin`); Étham (ID: `place:Etham`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); parler contre dieu (ID: `keyterm:Blaspheme`)
...
* **Associated ACAI Concepts:** évaluer (ID: `keyterm:Discern`); percevoir (ID: `keyterm:Perceive`)
## Disciple (id: 466831)
...
* **Associated ACAI Concepts:** trans. faire un disciple de (ID: `keyterm:Disciple`); A Disciple (ID: `person:GenericDisciple`)
## Disperser (id: 466833)
