...
* **Associated ACAI Concepts:** Olive Tree (ID: `flora:OliveTree`); montagne des oliviers (ID: `place:OlivesMount`)
...
* **Associated ACAI Concepts:** Hosée (ID: `person:Hoshea.2`); Hosée (ID: `person:Hoshea.3`); Josué (ID: `person:Joshua.2`); Osée (ID: `person:Hoshea`)
...
* **Associated ACAI Concepts:** Ozias (ID: `person:Uzziah.2`); Ozias (ID: `person:Uzziah.3`); Ozias (ID: `person:Uzziah.4`); Ozias (ID: `person:Uzziah.5`); Ozias (ID: `person:Uzziah`)
