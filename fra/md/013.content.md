...
* **Associated ACAI Concepts:** Kedesh (ID: `place:Kedesh.3`); Kédesch (ID: `place:Kedesh`); Kadès-Barnéa (ID: `place:Kadesh-barnea`)
...
* **Associated ACAI Concepts:** Koré (ID: `person:Korah.2`); Koré (ID: `person:Korah.3`); Koré (ID: `person:Korah.4`); Koré (ID: `person:Korah`)
